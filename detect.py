...
net = cv2.dnn.readNet("https://drive.google.com/file/d/1daz0QpbVSVSZDGYxhAqaozE1NqtcBZwF/view?usp=sharing", "yolov3-custom.cfg")
net.setPreferableBackend(cv2.dnn.DNN_BACKEND_CUDA)
net.setPreferableTarget(cv2.dnn.DNN_TARGET_CUDA)


model = load_model('https://drive.google.com/file/d/1uDsjrDubF0yGy1SrFF8g9r4wZzY4YhoL/view?usp=sharing')
print('model loaded!!!')
